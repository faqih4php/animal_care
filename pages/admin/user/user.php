        ...
        <div class="col-lg-11 col-12 mx-auto">
          <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center pb-0">
              <h6>Daftar User</h6>
              <!-- Add button -->
              <a href="" class="btn bg-gradient-success mt-2" data-bs-toggle="modal" data-bs-target="#adduser"><i class="fas fa-plus"></i> Tambah User</a>
            </div>
            ...
            <div class="card-body px-0 pt-0 pb-2">
                ...
                <thead>
                  <tr>
                    ...
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder ps-2">Nama User</th>
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td class="align-middle text-center">
                        <a href="" class="text-secondary font-weight-bold text-xs" data-bs-toggle="modal" data-bs-target="#editdokter"  data-id="<?= $row['id'] ?>" data-nama="<?= $row['nama'] ?>" data-username="<?= $row['username'] ?>" data-role="<?= $row['role'] ?>">
